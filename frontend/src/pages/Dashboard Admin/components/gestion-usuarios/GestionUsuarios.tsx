...
export function GestionUsuarios() {
  ...
  return (
    <div className="w-full space-y-8">
      {/* Header */}
      <div
        className="px-4 lg:px-6 animate-slide-in"
      ...
      <div className="px-4 lg:px-6 space-y-8">
        {/* Estadísticas */}
        <div
          className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-0 @xl/main:grid-cols-4 @5xl/main:grid-cols-4 animate-fade-in"
